...
import { Heart, Lock, User, Phone, Eye, EyeOff, ArrowLeft, Briefcase, Award } from 'lucide-react';
...
export default function RegisterDoctor() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/', {
        state: { message: 'Doctor registration successful! Please sign in.' }
      });
    } catch (error: any) {
      setError(
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      <div className="flex min-h-screen">
        ...
        {/* Left Side */}
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-indigo-600 p-12 flex-col justify-center items-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-lg">
            ...
            <p className="text-xl mb-8 opacity-90">
              Connect with patients and provide healthcare services
            </p>
          </div>
        </div>
